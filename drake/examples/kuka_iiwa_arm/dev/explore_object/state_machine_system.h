#ifndef DRAKE_EXAMPLES_KUKA_IIWA_ARM_DEV_EXPLORE_OBJECT_STATE_MACHINE_SYSTEM_H
#define DRAKE_EXAMPLES_KUKA_IIWA_ARM_DEV_EXPLORE_OBJECT_STATE_MACHINE_SYSTEM_H
 ...
 * Explore Object demo. This system should be used by coupling the outputs with
 ...
 * `SchunkWsgStatusSender` and `OracularStateEstimation` systems.
 */
class ExploreObjectStateMachineSystem : public systems::LeafSystem<double> {
 public:
  /**
   * Constructor for the ExploreObjectStateMachineSystem
   ...
   */
  ExploreObjectStateMachineSystem(
  ...
  /// Return the state of the explore object state machine.
  ExploreObjectState state(
      const systems::Context<double>&) const;

  // TODO(kmuhlrad): might need to change this, and everywhere else the world
  // is used... Compare with controlled_kuka_demo
...
#endif  // DRAKE_EXAMPLES_KUKA_IIWA_ARM_DEV_EXPLORE_OBJECT_STATE_MACHINE_SYSTEM_H